    ...
    <header className='Header-main'>
      ...
      <div className='Botonera'>
        <ul className={load ? 'menu on' : 'menu off'}>
          ...
          <li>
            <Link className={state3 && !state4 ? 'vincu on' : 'vincu'} to='Skills' smooth={true} offset={-200} duration={700}>Skills</Link>
          </li>
          <li>
            <Link className={state2 ? 'vincu on' : 'vincu'} to='Porfolio' smooth={true} offset={-100} duration={700}>Porfolio</Link>
          </li>
          <li>
